...
public class DeadFireflyBushBlock extends PlantBlock implements Fertilizable {
    public static final IntProperty AGE = IntProperty.of("age", 0, 2); // 0 = small, 1 = medium, 2 = full
    public static final MapCodec<DeadFireflyBushBlock> CODEC = createCodec(DeadFireflyBushBlock::new);

    public DeadFireflyBushBlock(Settings settings) {
        super(settings);
        this.setDefaultState(this.stateManager.getDefaultState().with(AGE, 0));
    }

    @Override
    protected MapCodec<? extends DeadFireflyBushBlock> getCodec() {
        return CODEC;
    }
