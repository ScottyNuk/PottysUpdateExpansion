...
public class ColdChickenModel<T extends ColdChickenEntity> extends AnimalModel<T> {

        public static final EntityModelLayer COLD_CHICKEN = new EntityModelLayer(Identifier.of(PottysUpdates.MOD_ID, "cold_chicken"), "main");
