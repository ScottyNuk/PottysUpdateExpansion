...
public class WarmChickenModel<T extends WarmChickenEntity> extends AnimalModel<T> {

    public static final EntityModelLayer WARM_CHICKEN = new EntityModelLayer(Identifier.of(PottysUpdates.MOD_ID, "warm_chicken"), "main");
    ...
    public WarmChickenModel(ModelPart root) {
    ...
    public void setAngles(T entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        float flap = MathHelper.sin(animationProgress * 0.3F) * entity.maxWingDeviation;
